...
/**
 * Extension for {@link FileIO} implementations that can obtain pre-signed URLs for their locations.
 * The URLs are not locations and are not stored in table metadata.
 */
public interface SupportsPreSigning {

  /**
   * Returns a pre-signed GET URL for each distinct location.
   *
